...
function recruitmentAssessment(p){const score = recruitmentScore(p);if(score >= 110){return {rating: "★★★★★ ELITE TARGET",colour: "#4CAF50",summary: "Immediate recruiting priority. Capable of impacting at the highest level."};}if(score >= 90){return {rating: "★★★★ HIGH PRIORITY",colour: "#8BC34A",summary: "Strong recruit with proven consistency and performance."};}if(score >= 70){return {rating: "★★★ DEVELOPING TARGET",colour: "#FFC107",summary: "Worth monitoring and viewing live."};}return {rating: "★★ DEPTH OPTION",colour: "#FF9800",summary: "Monitor but not an immediate priority."};}
